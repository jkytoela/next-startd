...
const listItems = [
  {
    title: `トライアルお申し込み`,
    description: `AwUN（アウン）の利用を開始するために、下記のリンクから利用開始
    の申請を行うことができます。貴社にとって最善のご提案をするためにお客様の必要情報
    をご記入ください。`,
    image: `fa-laptop`,
  ...
  {
    title: `お打ち合わせ`,
    description: `サービスに関すること、AwUN（アウン）導入の際にご提供いただく
    貨物の種類やアプリ画面の操作方法などをお話しします。対面、動画ミーティング、チャ
    ットなどでサポートいたします。貴社の営業利益向上のための準備をさせてください。`,
    image: `fa-handshake`,
    alt: `お打ち合わせイメージ画像`,
  },
  {
    title: `ログイン情報の送付`,
    description: `貴社の事前にいただいた情報を弊社で登録し、AwUN（アウン）運営よ
    りログインに必要なメールアドレスとパスワードを送付させていただきます。`,
    image: `fa-envelope`,
    alt: `ログイン情報の送付イメージ画像`,
  },
  {
    title: `導入完了• 利用開始`,
    description: `アプリを使ってすぐに最大 2 割引の料金でチャーター便の手配などを
    行うことができます。輸送コストを抑えながら、新たな輸送網を構築しましょう。`,
    image: `fa-truck`,
    alt: `導入完了• 利用開始イメージ画像`,
  },
];
