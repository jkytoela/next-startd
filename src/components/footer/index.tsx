...
const productLinks = [`荷主の方`, `運送会社の方`];
const aboutLinks = [`会社概要`, `プライバシーポリシー`, `ブログ`];
const resourceLinks = [
  `Get started`,
  `Guides`,
  `Tools`,
  ...
  <footer className={tw(`bg-white border-t border-gray-400 pt-14 pb-16`)}>
    <div className={tw(`max-w-7xl mx-auto text-gray-400 px-8 lg:px-0 flex flex-wrap`)}>
      <div className={tw(`mb-14 flex items-center w-full`)}>
        <img className={tw(`h-12 w-12 mr-4 object-contain`)} src="awunlogo.png" alt="logo" height={48} />
        <p className={tw(`text-4xl text-indigo-500 font-bold`)}>AwUN</p>
      </div>
